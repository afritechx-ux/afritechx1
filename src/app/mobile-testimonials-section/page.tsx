...
<p className="text-lg font-bold leading-normal text-slate-900 dark:text-slate-100">John Doe</p>
<p className="text-sm font-normal leading-normal text-slate-500">CEO at TechCorp</p>
</div>
</div>
<div className="flex items-center justify-center gap-3">
<button aria-label="Go to slide 1" className="w-2.5 h-2.5 rounded-full bg-primary"></button>
<button aria-label="Go to slide 2" className="w-2.5 h-2.5 rounded-full bg-slate-300 dark:bg-slate-700 hover:bg-primary/50 transition-colors"></button>
<button aria-label="Go to slide 3" className="w-2.5 h-2.5 rounded-full bg-slate-300 dark:bg-slate-700 hover:bg-primary/50 transition-colors"></button>
<button aria-label="Go to slide 4" className="w-2.5 h-2.5 rounded-full bg-slate-300 dark:bg-slate-700 hover:bg-primary/50 transition-colors"></button>
</div>
</div>
</main>
